...
ちなみに，jsPsychでは日本語表示ができますが，フルスクリーン化のプラグイン（jspsych-fullscreen.js）は英語標記になります。そこで，その日本化版（jspsych-fullscreen_jp.js）を作成して，上記でダウンロードしたjspsych-6.1.0内に保存しています。jspsych-fullscreen_jp.jsを使えば，フルスクリーン化の教示も日本語になります。
